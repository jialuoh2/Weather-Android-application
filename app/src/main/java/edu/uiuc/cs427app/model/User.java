...
public class User implements Serializable {
    ...
    /**
     * this method is used to store user preferences
     ...
     * @param userPreferences - user preferences
     */
    public User(String userId, String userName, String password, List<UserSelectedLocation> userSelectedLocations, UserPreferences userPreferences) {
        this.userId = userId;
        this.userName = userName;
        this.password = password;
        this.userSelectedLocations = userSelectedLocations;
